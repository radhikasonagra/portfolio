  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch("https://formsubmit.co/ajax/radhikasonagra2003@gmail.com", {
        ...
        body: JSON.stringify({
          // Visible fields in the email (Capitalized for better looks in table)
          Email: formData.email,
          Message: formData.message,
          Name: formData.name,
          ...
          _replyto: formData.email, // Allows you to click 'Reply' and send to the user
          _template: 'table',       // Clean table layout
          _captcha: 'false',        // Disable robot check
        })
      });
